...
def test_deepeval_emits_evaluation_client_metrics(monkeypatch) -> None:
...
def test_evaluator_parses_judge_results(monkeypatch) -> None:
...
def test_metric_threshold_option_affects_label(monkeypatch) -> None:
    invocation = _build_invocation()
