...
# overwrite OTEL_INSTRUMENTATION_GENAI_EVALS_EVALUATORS=deepeval
os.environ["OTEL_INSTRUMENTATION_GENAI_EVALS_EVALUATORS"] = "deepeval"
# set the openai key to an invalid key which will cause the evaluation to fail
os.environ["OPENAI_API_KEY"] = "invalid_key"
os.environ["OTEL_RESOURCE_ATTRIBUTES"] = (
    "deployment.environment=example_evaluation_errors"
)
