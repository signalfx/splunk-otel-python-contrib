...
| `OTEL_INSTRUMENTATION_GENAI_EVALUATION_RATE_LIMIT_ENABLE` | Enable evaluation rate limiting                                                        | Boolean (default: false). Set to 'true' to enable rate limiting              |
| `OTEL_INSTRUMENTATION_GENAI_EVALUATION_RATE_LIMIT_RPS` | Evaluation request rate limit (requests per second)                                      | Float (default: 0, disabled). Example: 0.1 = 1 request per 10 seconds         |
