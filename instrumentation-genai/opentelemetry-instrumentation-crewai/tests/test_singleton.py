...
class TestTelemetryHandlerSingleton:
    ...
    def test_handler_is_set_after_instrumentation(self, tracer_provider, meter_provider):
        """Handler should be set after instrument() is called."""
        instrumentor = CrewAIInstrumentor()
        
        # Mock the wrap_function_wrapper to avoid importing crewai
        with mock.patch("opentelemetry.instrumentation.crewai.instrumentation.wrap_function_wrapper"):
    ...
    def test_handler_is_telemetry_handler_instance(self, tracer_provider, meter_provider):
    ...
    def test_handler_uses_default_tracer_provider_when_not_provided(self, meter_provider):
    ...
    def test_handler_uses_default_meter_provider_when_not_provided(self, tracer_provider):
    ...
    def test_reinstrumentation_is_prevented_by_base_class(self, tracer_provider, meter_provider, caplog):
