"""OAuth2 Token Manager for custom OpenAI-compatible endpoints."""
...
class OAuth2TokenManager:
    ...
    for use with OpenAI Agents SDK with custom endpoints.
    ...
    def _refresh_token(self) -> str:
        ...
        assert self.token_url is not None  # Validated in __init__
